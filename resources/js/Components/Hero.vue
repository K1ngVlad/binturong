...
<template>
    <section :style="{backgroundImage: 'url(' + backgroundUrl + ')', backgroundSize: 'cover', objectFit: 'cover'}" class="flex p-4 h-28 text-orange-600">
        <div class="h-full">
            <img class="h-full" alt="logo" :src="logoImgurl"/>
        </div>
